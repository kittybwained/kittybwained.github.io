...
<head>
    <meta charset="UTF-8">
    <title>Programs - Neko Data Systems</title>
            ...
            <tr>
                ...
                <td rowspan="2" align="LEFT" valign="TOP">
                    <font face="Helvetica Neue LT Std, Helvetica LT Std, Helvetica, sans-serif" size="3">
                        ...
                        <h3>Nekodata Type-III Library</h3>
                        <p>The Nekodata Type-III library is a catalogue of permissively licensed programs.</p>
                        <ul>
                            <li><a href="https://github.com/nekodata/tdfa">2614-XLP</a> — Ada 2022 implementation of Tagged Deterministic Finite Automata</li>
                        </ul>
                    </font>
                </td>
            </tr>
